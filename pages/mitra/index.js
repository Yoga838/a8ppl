      ...
      <div className="row ">
        ...
        <div className="col-md-8 pe-5 sidebar-right color-brown pt-5">
          ...
          <div className="d-flex justify-content-between ms-5 mt-5 me-4">
            <Link href='/mitra/grafik'><button className="btn btn-lg bg-color-green shadow rounded-pill text-light poppins fw-bold ">Grafik Pencatatan &nbsp;<img src="/images/grafik.png" alt="" /></button></Link>
