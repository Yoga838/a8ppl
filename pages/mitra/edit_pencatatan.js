    ...
    <div className="content">
      <div className="row">
        ...
        <div className="button-left d-flex justify-content-end gap-4 mt-5 mb-4">
            <button type="button" onClick={(e)=>{e.stopPropagation(),router.replace('/mitra')}} className="btn btn-admin bg-color-red poppins text-white shadow rounded-pill  btn-lg">Batal</button>
