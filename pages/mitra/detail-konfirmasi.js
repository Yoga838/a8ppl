      ...
      <div className="row">
        ...
        <div className='content2 d-flex flex-column align-items-center gap-2'>
          ...
          <div className="button-item d-flex flex-column align-items-center gap-4">
            ...
            <Link href="/mitra/konfirmasi-pendistribusian"><button type="button" className="btn text-warning btn-admin btn-light poppins rounded-pill shadow btn-lg">Konfirmasi Pendistribusian</button></Link>
